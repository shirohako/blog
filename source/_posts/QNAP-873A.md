...
等一会会自动重启,安装过程也挺长的.顺便一提QNAP的系统启动时间,真的非常长...

![](https://ae01.alicdn.com/kf/H40bac3d323c647a1a2c00447eb2dc7eai.png)

能看到登录界面就好了,第一次接入后,有一堆用户协议条款要同意
...
功耗方面表现还是很满意的,我插了一块18T硬盘后在24W左右.
全天开机一个月应该不到20度
...
即使是企业级的成品NAS并不是什么不可及的东西.
集成主板,内存,电源,硬盘隆,风扇,机箱.凑齐了这些一台 Mini PC 而已.
成品NAS大多数人而言稳定和售后可能更加重要.

如果你有能力也爱折腾的话,而且可以用更低廉的价格,租一台更高配置的出来.
